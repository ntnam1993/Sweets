...
<html lang="ja">
    ...
    <body class="error500">
        ...
        <img src="/assets/mobile/images/sweets500_sp.jpg" alt="" class="img-404">
        @if(isset($hasInfo) && $hasInfo)
        <p class="p-button p-button-green p-button-cus p-submit btn-404-err"><a href="{{ route('product.detail', $prodId) }}">商品詳細画面へ戻る</a></p>
        @else
        <p class="p-button p-button-green p-button-cus p-submit btn-404-err"><a href="/">TOPへ戻る</a></p>
        @endif
        </div>
        <!-- content -->
