...
<html lang="ja">
    <head>
        ...
        <link rel="stylesheet" href="/assets/pc/css/pc.css">
        <link rel="stylesheet" href="/assets/pc/css/custom.css">
        <link rel="stylesheet" href="/assets/pc/css/custom-pc.css">
        ...
        <link rel="stylesheet" href="/assets/pc/css/custom.css">
        <!-- s rateit -->
        <link media="all" type="text/css" rel="stylesheet" href="/assets/pc/js/rateit/rateit.css">
    ...
    <body class="{{ $tBody }}">
        ...
        <div class="{{ $tConten }}">
            ...
            <img src="/assets/pc/images/sweets500.jpg" alt="" class="img-404">
            @if(isset($hasInfo) && $hasInfo)
            <p class="p-button p-button-whiteback back-product hover-a"><a href="{{ route('product.detail', $prodId) }}">商品詳細画面へ戻る</a></p>
            @else
            <p class="p-button p-button-whiteback back-product hover-a"><a href="/">TOPへ戻る</a></p>
            @endif
        </div>
        <!-- t-conten -->
