...
<li>
    <div class="">
        ...
        <div class="div-des-ul-l-2">
            <p class="p-tit-ch-ul2 cake-name"><a class="other-product-link" href="{{ route('floprestige.shop.detail', [$shopId,$product->product_id]) }}">{{ subString($product->product_name,12) }}</a></p>
            <!-- rate19 -->
        </div>
    ...
    <div class="text-center">
        <p class="p-button p-button-green new-p-button p-resv-red text-cent" style="height: 42px;width: 180px!important;font-size: 16px;">
            <a class="reservation-btn cursor-ponter" href="{{ route('floprestige.shop.detail', [$shopId,$product->product_id]) }}"><span class="pa-l-20">予約可</span></a>
        </p>
    </div>
    @endif
</li>
