<html lang="ja">
    ...
    <body class="shop-detail error301">
        <div class="over"></div>
        @include('masters.mobile.main-menu')
        <img src="/assets/images/loading.svg" alt="" id="loading">
        @php($keyShowBanner = true)
        @include('masters.mobile.shop-header', compact("keyShowBanner"))
        <!-- header -->
        @yield('search')
								<div class="sp-container clearfix css-new">
									<div class="sp-container clearfix">
											<div class="end_error">
											<img src="/assets/mobile/images/sweets301.jpg" alt="" class="img-404">
											<p class="end_error_sentence">お探しの店舗の掲載は終了しました</p>
											</div>
											<p class="p-button p-button-green p-button-cus p-submit btn-404-err"><a href="https://sweetsguide.jp/">他の店舗を探す</a></p>
									</div>
								</div>
        <!-- content -->
